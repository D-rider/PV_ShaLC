...
logging.basicConfig(filename='DEBUG.csv',level=logging.DEBUG,filemode='w')

logging.debug("HourAngle;Azimuth;Altitude")
...
def Shadow():
    ...
    print("Objeto 1:")
    print("\tAzimut izquierda:\t%s")%(_az_a*180/np.pi)
    print("\tAltura izquierda:\t%s")%(_alt_a*180/np.pi)
    print("\tAzimut derecha:\t\t%s")%(_az_b*180/np.pi)
    print("\tAltura derecha:\t\t%s")%(_alt_b*180/np.pi)
